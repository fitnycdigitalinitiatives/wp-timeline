...
function wp_bootstrap_starter_posted_on() {
	...
	$posted_on = sprintf(
		esc_html_x( 'Posted on %s', 'post date', 'timeline-theme' ),
		$time_string
	);

	$byline = sprintf(
		esc_html_x( 'by %s', 'post author', 'timeline-theme' ),
...
function wp_bootstrap_starter_entry_footer() {
	...
	edit_post_link(
		sprintf(
			...
			esc_html__( 'Edit %s', 'timeline-theme' ),
       ...
       // $GLOBALS['comment'] = $comment;
        ...
        if ( 'pingback' == $comment->comment_type || 'trackback' == $comment->comment_type ) : ?>
            ...
            <div class="comment-body">
                <?php _e( 'Pingback:', 'timeline-theme' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( 'Edit', 'timeline-theme' ), '<span class="edit-link">', '</span>' ); ?>
            </div>
                ...
                <div class="media-body">
                    <div class="media-body-wrap card">
                        ...
                        <div class="card-header">
                            <h5 class="mt-0"><?php printf( __( '%s <span class="says">says:</span>', 'timeline-theme' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?></h5>
                        ...
                        <?php if ( '0' == $comment->comment_approved ) : ?>
                            <p class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'timeline-theme' ); ?></p>
                        <?php endif; ?>
